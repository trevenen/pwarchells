######################################################################
##  Windows Server Disk Reporter.
##  This tool will increase IO and Load.
##  Run when Server isn't busy or wait.
##  Author: Thayne "The Linux Guy" Trevenen
######################################################################

# Modify these 3 variables as needed

# Output file location and name
$findFilesFoldersOutput = "C:\Output_Of_Find_Largest_Files_And_Folders.txt";
# Drive to Scan
$diskDrive = "C:"
...
######################################################################
## Do not edit below unless you are willing to fix what breaks!
######################################################################
# Misc settings
